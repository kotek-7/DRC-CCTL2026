...
static void MX_GPIO_Init(void) {
  ...
  HAL_GPIO_WritePin(GPIOA, LED_BI_Pin | RGB_Pin | I2C2_INT_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pins : LED_BI_Pin RGB_Pin I2C2_INT_Pin */
  GPIO_InitStruct.Pin = LED_BI_Pin | RGB_Pin | I2C2_INT_Pin;
